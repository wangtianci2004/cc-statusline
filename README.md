...
❯ Hello ～
───────────────────────────────────────────────────────────────────────────────────────────────────────────────
Opus 4.7 | ~/cc-statusline main'+2↑1 | 35.2k/8% | 1R:0·Rq:4·ΔW:1.8k·ΣW:35.6k | R$1.17·T$3.62·D$3.80·M$48.21 | 5H:3%(16:30)·7D:5%
```
...
| `R8¢·T$1.23·D$4.50·M$48.21` | 本轮（R）/ 会话总（T）/ 今日跨会话累计（D）/ 本月跨会话累计（M） |
...
- `~/.claude/.cost-month-YYYY-MM.json` — 当月按日花费聚合（>70 天自动清理）
